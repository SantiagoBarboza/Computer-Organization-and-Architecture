...
seja armazenado no registrador $a0) para outro vetor (cujo endereço base seja armazenado no registrador 
$a1) pondo o número de palavras copiadas no registrador $v0. 
O programa para de copiar quando encontrar uma palavra (no primeiro vetor) igual a valor informado 
pelo usuário. O número de palavras copiadas deve ser apresentado na tela.
